...
# フラグの hex 長は全問題で共通(各章の setup.sh・terraform/scripts/flags.py と揃える)
HEX_LEN = 32

# (章, 問題ID): 通知での表示名。章を作るたびにここへ追加する。
QUESTIONS = {
    ("ch01", "q1"): "第1章 問題1「捨てられたフラグ」",
    ("ch01", "q2"): "第1章 問題2「起動しない greeter」",
    ("ch02", "q1"): "第2章 問題1「眠り続けるデーモン」",
    ("ch02", "q2"): "第2章 問題2「倒せないプロセス」",
    ("ch03", "q1"): "第3章 問題1「気難しい預言者」",
    ("ch03", "q2"): "第3章 問題2「CPU を譲らない同居人」",
    ("ch04", "q1"): "第4章 問題1「生きているプロセスのメモリ」",
    ("ch04", "q2"): "第4章 問題2「OOM で死につづけるサービス」",
    ("ch05", "q1"): "第5章 問題1「無口な郵便屋」",
    ("ch05", "q2"): "第5章 問題2「消える予約」",
    ("ch06", "q1"): "第6章 問題1「開かずの金庫」",
    ("ch06", "q2"): "第6章 問題2「7年前に巻き戻った業務データ」",
    ("ch07", "q1"): "第7章 問題1「消えたファイルのフラグ」",
    ("ch07", "q2"): "第7章 問題2「いっぱいなのに空いている cache」",
    ("ch08", "q1"): "第8章 問題1「幻を映すファイル」",
    ("ch08", "q2"): "第8章 問題2「書き込みが遅すぎる」",
    ("ch09", "q1"): "第9章 問題1「ディスクに書かれなかったフラグ」",
    ("ch09", "q2"): "第9章 問題2「親切すぎるチューナー」",
    ("ch10", "q1"): "第10章 問題1「消された仮想ディスク」",
    ("ch10", "q2"): "第10章 問題2「起動しない仮想マシン」",
    ("ch11", "q1"): "第11章 問題1「別世界の金庫」",
    ("ch11", "q2"): "第11章 問題2「1回しか動かないコンテナ」",
    ("ch12", "q1"): "第12章 問題1「秘密は絞られたときだけ」",
    ("ch12", "q2"): "第12章 問題2「何度でも殺されるワーカー」",
}


def expected_flag(participant, chapter, qid):
    digest = hmac.new(
        os.environ["FLAG_SECRET"].encode(),
        f"{participant}:{chapter}-{qid}".encode(),
        hashlib.sha256,
    ).hexdigest()
    return f"flag{{{digest[:HEX_LEN]}}}"
...
def lambda_handler(event, context):
    ...
    for (chapter, qid), title in QUESTIONS.items():
        if hmac.compare_digest(flag, expected_flag(participant, chapter, qid)):
